...
NOTE: Currently, Petrichor exports AutoHotkey v1 scripts, so you'll need to install v1. Wi know v1 is deprecated, updating Petrichor to export v2 scripts is planned for a future release.
