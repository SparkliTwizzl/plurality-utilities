...
---
<h1 align="center">Petrichor</h1>
<h2 align="center">Version 0.8</h2>
...
!!! important
    ...
    All tag fields *should* be unique in order for the generated script to work correctly, even though Petrichor wont take issue with it. If a tag field is repeated, only the first one in the script will work.
...
##### 4.2.2.4 - generateA
HKShortcutScript command `--logFile` option
