...
namespace Petrichor.ShortcutScriptGeneration.Utilities.Tests
{
	...
	public class ScriptGeneratorTests
	{
		public readonly struct TestData
		{
			...
			public static InputData Input => new( ModuleOptions, EntryList, TemplateList, Macros );
			public static string[] Macros =>
			[
				"macro",
			];
			public static ModuleOptionData ModuleOptions => new( $"\"{TestAssets.DefaultIconFilePath}\"", $"\"{TestAssets.SuspendIconFilePath}\"", TestAssets.ReloadShortcut, TestAssets.SuspendShortcut );
